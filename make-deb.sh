...
# Icon (PNG 256x256)
cp contestlogbook.png $PKGDIR/usr/share/icons/hicolor/256x256/apps/


# Launcher
cp contestlogbook $PKGDIR/usr/bin/
...
contestlogbook (0.5-1) stable; urgency=low
 ...
 -- John M. Belstner <john@w9en.com>  Sat, 16 Nov 2025 12:00:00 -0700
EOF

cat > $PKGDIR/usr/share/doc/${APP}/copyright << 'EOF'
Format: http://www.debian.org/doc/packaging-manuals/copyright-format/1.0/
Upstream-Name: ContestLogBook
Source: https://github.com/john-belstner/ContestLogBook
